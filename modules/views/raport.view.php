...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="table-responsive">
            ...
            <a class="btn btn-block btn-primary fa fa-print" href="modules/views/RAPORT.php?nis=<?php echo $siswa->nis; ?>"> Cetak Sertifikat </a>
            <!--<form action="modules/views/LAPORAN.php" method="POST">-->
